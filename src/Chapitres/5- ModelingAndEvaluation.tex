...
\subsectiont{Linear \& Simple Models:}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l c X}
        ...
        \toprule
        \textbf{Modèle} & \textbf{MCC} & \textbf{Observations} \\
        \midrule % Ligne du milieu

        Logistic Regression & 0.54 & ____. \\
        \addlinespace % Petit espace pour aérer

        Random Forest & 0.63 &  plus long. \\
        \addlinespace

        XGBoost & \textbf{0.65} & Meilleure performance globale. Capture bien les interactions entre l'âge et les heures de travail. \\

        \bottomrule % Belle ligne du bas
